...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Sidebar Toggle-->
    <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fa fa-bars" aria-hidden="true" aria-hidden="true"></i></button>
    <!-- Navbar Search-->
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{route('customers.index')}}">
                        ...
                        <div class="sb-nav-link-icon"><i class="fa fa-tags" aria-hidden="true"></i></div>
                            Tags
